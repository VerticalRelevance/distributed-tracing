    ...
    def trace_calls(self, file_path: str, function_name: str, indent: int = 0) -> None:
        ...
        for call in calls:
            ...
            if "." in function_name and not "." in call:
                ...
                if call_def:
                    self.trace_calls(actual_file, qualified_call, indent + 2)
                    continue
            ...
            if call_def:
                ...
                if (
                    ...
                    self.trace_calls(call_source or actual_file, call, indent + 2)
            else:
                ...
                if call_file:
                    ...
                    for cls_name, methods in classes.items():
                        if call in methods:
                            ...
                            self.trace_calls(call_file, qualified_call, indent + 4)
                            break
                    else:
                        ...
                        self.trace_calls(call_file, call, indent + 4)
                else:
...
def main():
    ...
    # Start tracing
    tracer.trace_calls(source_file, function_name)
...
if __name__ == "__main__":
    """
    python python_function_call_tracer_v10.py path/to/source.py function_name
    # For methods:
    python python_function_call_tracer_v10.py path/to/source.py ClassName.method_name
    """
    main()
